...
GANTRY="./gantry.native"
#GANTRY="_build/microc.native"
...
Check() {
    ...
    Run "$CC" "-o" "${basename}.exe" "${basename}.s" \
	  ...
	  "gantrylib_obj.o" "gantrylib_nap.o" \
          "gantrylib_printb.o" "$LDFLAGS" &&
...
CheckFail() {
    ...
    generatedfiles="$generatedfiles ${basename}.ll ${basename}.s ${basename}.exe ${basename}.err ${basename}.diff" &&
